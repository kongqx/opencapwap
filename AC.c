...
#ifdef CASKY_DEBUG
#ifndef CASKY_PRT
#define CASKY_PRT(format,args...) fprintf(stdout, "[%s:%d] "format"\n", __FUNCTION__, __LINE__, ##args)
#endif
#endif
...
//Elena Agostini: Unique AC Tap Interface
	...
	CASKY_PRT("Found %d Network Interface(s)", gInterfacesCount);
